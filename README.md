...
1. Получение токенов
    ...
    - COOKIE — значение cookie из браузера, где вы уже авторизованы в Яндекс Музыке (найти можно через инструменты разработчика, вкладка "Сеть" или "Хранилище"). **Обязательно для получения истории прослушивания.**
2. Запуск контейнера
...
| `COOKIE`               | ✅           | Cookie из браузера с авторизацией Яндекс Музыки                  |
...
- Для endpoint истории прослушивания Яндекс Музыки требуется актуальная `COOKIE`; без неё скробблинг не сможет получать текущий трек.
